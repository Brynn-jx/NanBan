...
declare const _default: import("vue").DefineComponent<{
    ...
    mergedType: import("vue").ComputedRef<import("element-plus/es/utils").EpPropMergeType<(new (...args: any[]) => ("primary" | "defalut") & {}) | (() => "primary" | "defalut") | ((new (...args: any[]) => ("primary" | "defalut") & {}) | (() => "primary" | "defalut"))[], unknown, unknown> | undefined>;
    nextZIndex: () => number;
    nowZIndex: number;
