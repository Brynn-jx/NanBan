...
const useSelect = (props, emit) => {
  ...
  const { wrapperRef, isFocused, handleFocus, handleBlur } = index$4.useFocusController(inputRef, {
    afterFocus() {
  ...
  const hasModelValue = vue.computed(() => {
    return props.multiple ? shared.isArray(props.modelValue) && props.modelValue.length > 0 : props.modelValue !== void 0 && props.modelValue !== null && props.modelValue !== "";
  });
